...
function generateTableCurrency(currency) {
    ...
    for (var i = 0; i < currency.length; i++) {
        currencyTable += '<tr>'+
            '<td><img style="width:40px;" src="/img/lang/lang_' + currency[i].currencyCode+'.png">' + currency[i].currencyCode + '</td>'+
...
function generateCurrencyConvert(currency) {
    var currencyConvert = '';
    for (var i = 0; i < currency.length; i++) {
        currencyConvert += '<div class="col-xs-12 col-sm-6 col-md-4"><div class="item-exm"><div style="padding-right: 10px;" class="flag"><img src="/Content/user/image/lang/lang_' + currency[i].currencyCode + '.png"></div><div class="ex-info"><div class="rate">' + currency[i].convertCurrency+ ' $</div><div class="unit">' + currency[i].currencyCode+'</div></div></div></div>';
    }
