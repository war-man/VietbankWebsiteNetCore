...
function getListPromotionNews() {
    requestAjaxGet('/api/ApiPersonal/getlistpromotionnews/0/9').done(function (data) {
...
function getListPromotionNewsWithPagination(pageCurrent) {
    requestAjaxGet('/api/ApiPersonal/getlistpromotionnews/' + pageCurrent + '/9').done(function (data) {
        $('#lst-news').html(loopNews(data.listNewsItems));
    }).fail();
}
